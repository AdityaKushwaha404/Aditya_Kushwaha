...
const bullets = [
  {
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-yellow-300">
    ...
    <section id="why-me" className="py-20">
      ...
      <div className="mx-auto mt-12 max-w-5xl">
        ...
        <div className="relative rounded-3xl p-6 md:p-10 bg-[rgb(14_18_49/0.22)] border border-white/15 ring-1 ring-white/20 backdrop-blur-2xl shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_16px_48px_rgba(2,6,23,0.6)]">
          {/* faint grid pattern */}
          <div className="pointer-events-none absolute inset-0 rounded-3xl opacity-[0.06]" style={{
          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-8">
            {bullets.map((b, i) => (
              ...
              >
                ...
                <div className={`absolute left-0 top-0 h-full w-[3px] rounded-l-2xl bg-gradient-to-b ${b.accent} z-20`} />
